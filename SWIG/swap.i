...
typedef boost::shared_ptr<PricingEngine> TreeVanillaSwapEnginePtr;
...
%rename(TreeVanillaSwapEngine) TreeVanillaSwapEnginePtr;
class TreeVanillaSwapEnginePtr : public boost::shared_ptr<PricingEngine> {
    public:
    %extend {
        TreeVanillaSwapEnginePtr(const boost::shared_ptr<ShortRateModel>& model,
                              Size timeSteps,
                              const Handle<YieldTermStructure>& termStructure =
                                                 Handle<YieldTermStructure>()) {
            return new TreeVanillaSwapEnginePtr( new TreeVanillaSwapEngine(model,
                                                                           timeSteps,
                                                                           termStructure));
        }
        TreeVanillaSwapEnginePtr(const boost::shared_ptr<ShortRateModel>& model,
