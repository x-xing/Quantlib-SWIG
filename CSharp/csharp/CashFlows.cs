...
public class CashFlows : global::System.IDisposable {
  ...
  public static Date previousCashFlowDate(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    Date ret = new Date(NQuantLibcPINVOKE.CashFlows_previousCashFlowDate__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Date previousCashFlowDate(Leg leg, bool includeSettlementDateFlows) {
    Date ret = new Date(NQuantLibcPINVOKE.CashFlows_previousCashFlowDate__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Date nextCashFlowDate(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    Date ret = new Date(NQuantLibcPINVOKE.CashFlows_nextCashFlowDate__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Date nextCashFlowDate(Leg leg, bool includeSettlementDateFlows) {
    Date ret = new Date(NQuantLibcPINVOKE.CashFlows_nextCashFlowDate__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
