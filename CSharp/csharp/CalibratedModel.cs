...
public class CalibratedModel : global::System.IDisposable {
  ...
  public void setParams(QlArray arg0) {
    NQuantLibcPINVOKE.CalibratedModel_setParams(swigCPtr, QlArray.getCPtr(arg0));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public double value(QlArray arg0, CalibrationHelperVector arg1) {
    double ret = NQuantLibcPINVOKE.CalibratedModel_value(swigCPtr, QlArray.getCPtr(arg0), CalibrationHelperVector.getCPtr(arg1));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
