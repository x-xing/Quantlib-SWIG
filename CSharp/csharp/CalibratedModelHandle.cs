...
public class CalibratedModelHandle : global::System.IDisposable {
  ...
  public void setParams(QlArray arg0) {
    NQuantLibcPINVOKE.CalibratedModelHandle_setParams(swigCPtr, QlArray.getCPtr(arg0));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public double value(QlArray arg0, CalibrationHelperVector arg1) {
    double ret = NQuantLibcPINVOKE.CalibratedModelHandle_value(swigCPtr, QlArray.getCPtr(arg0), CalibrationHelperVector.getCPtr(arg1));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
