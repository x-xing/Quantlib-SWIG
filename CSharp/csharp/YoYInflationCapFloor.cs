...
public class YoYInflationCapFloor : Instrument {
  ...
  internal YoYInflationCapFloor(global::System.IntPtr cPtr, bool cMemoryOwn) : base(NQuantLibcPINVOKE.YoYInflationCapFloor_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public YoYInflationCapFloor() : this(NQuantLibcPINVOKE.new_YoYInflationCapFloor(), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
